/*
  # Add role and create leads/clients tables

  1. Changes
    - Add role column to todo_profiles if not exists
...
-- Create leads policies with existence checks
DO $$ 
BEGIN
  IF NOT EXISTS (
...
-- Create clients policies with existence checks
DO $$ 
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
